...
class Knowledge(object):
    def __init__(self, weather_api_token, ipstack_ai_token,news_country_code='IN'):
        self.news_country_code = news_country_code
        self.weather_api_token = weather_api_token
        self.ipstack_ai_token=ipstack_ai_token
    ...
    def get_location(self):
        # get location
        location_req_url = "http://api.ipstack.com/%s?access_key=%s&output=json&legacy=1" % (self.get_ip(),self.ipstack_ai_token )
